...
class SearchClient implements OpenSearchSearcherServiceIf {
     ...
     * @return void
     */
    public function __construct($openSearchClient,\OpenSearch\Util\SearchParamsBuilder &$searchParamsBuilder) {
    ...
    public function search(){
        return $this->execute($this->searchParamsBuilder->build());
    }
}